...
function init() {
    $("#commenthub_thread").html("<iframe style='width: 100%;height: 100%;border: none;' src='http://localhost:8080/comments?commenthub_website=" + commenthub_website + "&commenthub_identifier=" + commenthub_identifier + "'></iframe>");
}
